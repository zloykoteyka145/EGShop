...
fetch(url, {
    ...
    $('.button1').click(function () {
        $('.ident').attr("value", data.rows[0].id_goods);
        $('.popupnamech').text(data.rows[0].name_goods);
        PopUpShow();
    });
    $('.button2').click(function () {
        $('.ident').attr("value", data.rows[1].id_goods);
        $('.popupnamech').text(data.rows[1].name_goods);
        PopUpShow();
    });
    $('.button3').click(function () {
        $('.ident').attr("value", data.rows[2].id_goods);
        $('.popupnamech').text(data.rows[2].name_goods);
        PopUpShow();
    });
}).catch(console);